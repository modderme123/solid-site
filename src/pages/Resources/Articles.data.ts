...
export const articles: Array<Resource> = [
  ...
  },
  {
    ...
    title: 'Client-side Routing without the JavaScript',
    description:
      'Ryan discusses client-side routing without JavaScript as it relates to different frameworks.',
    author: 'Ryan Carniato',
    author_url: 'https://dev.to/ryansolid',
    keywords: ['solid', 'routing', 'javascript'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1666461204000,
  },
  {
    link: 'https://dev.to/this-is-learning/react-vs-signals-10-years-later-3k71',
    title: 'React vs Signals: 10 Years Later',
    description:
      'Ryan discusses React versus Signals in 2023 and provides some insight into the larger debate on approaches.',
    author: 'Ryan Carniato',
    author_url: 'https://dev.to/ryansolid',
    keywords: ['solid', 'signals', 'react', 'reactivity'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1677696804000,
  },
  {
    link: 'https://dev.to/this-is-learning/making-the-case-for-signals-in-javascript-4c7i',
    title: 'Making the Case for Signals in JavaScript',
    description: 'Ryan provides a case and arguments for a future embracing signals.',
    author: 'Ryan Carniato',
    author_url: 'https://dev.to/ryansolid',
    keywords: ['solid', 'signals', 'reactivity'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],

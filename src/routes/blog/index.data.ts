...
import { ListenNotesEpisodeProps } from 'solid-social/dist/types/components/listennotes/listennotes-episode';
import { TwitchProps } from 'solid-social/dist/types/components/twitch/twitch';
import { TweetProps } from 'solid-social/dist/types/components/twitter/tweet';
import { YouTubeProps } from 'solid-social/dist/types/components/youtube/youtube';

export type MDXComponent = Component<{
  components: {
    ListenNotesEpisode?: Component<ListenNotesEpisodeProps>;
